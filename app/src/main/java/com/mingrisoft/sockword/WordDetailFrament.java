...
public class WordDetailFrament extends Fragment implements View.OnClickListener, SynthesizerListener {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        setParam();
        //初始化
        SpeechUser.getUser().login(getContext(),null,null,"appid=5cb7368a",listener);
    ...
    public  void translationStrat(String word) throws IOException, JSONException {
        String queryResult="";                     //翻译后的结果

        queryResult=TranslationService.start(word);
    ...
    private void setParam(){
        speechSynthesizer=SpeechSynthesizer.createSynthesizer(getContext());
        //设置发音人名(讯飞晓燕)
